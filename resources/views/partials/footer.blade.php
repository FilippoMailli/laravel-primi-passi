<footer>
    <div class="footer-list">
        <ul class=first-footer-list>
            <li><img src="{{asset('img/marchio-sito-test.png')}}" alt="La Molisana"></li>
        ...
        <div class="lista-unica">
            <ul class= second-footer-list>
                <li>PASTIFICIO</li>
                <li><a href="#">Il Pastificio</a></li>
                <li><a href="#">Gran decorticato a pietra</a></li>
        ...
        <ul>
            ...
            <li><a>Collezione da Chef</a></li>
            <li><a>Grandi Cucine</a></li>
            <li><a>Biologiche</a></li>
            <li><a>Quadrate</a></li>
        </ul>
